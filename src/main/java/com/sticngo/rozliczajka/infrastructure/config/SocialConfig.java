...
import com.sticngo.rozliczajka.infrastructure.security.SecurityImplicitConnectionSignUp;
...
public class SocialConfig implements SocialConfigurer {
  ...
  public UsersConnectionRepository getUsersConnectionRepository(
    ...
    repository.setConnectionSignUp(
        new SecurityImplicitConnectionSignUp(userRepository, roleRepository,memberRepository, passwordEncoder));
    return repository;
  }
}
